...
class Character {
  constructor (name, type) {
    this.name = name;
    this.type = type;
    this.getInfo = () => {return `This is a ${this.type} character named ${this.name}.`;}
  }
}
...
class NPC extends Character {
  constructor (name, type, location, phrase) {
    ...
    this.phrase = phrase;
    this.dialogue = () => {return `${this.name}: ${this.phrase}`}
  }
}
...
fireSpitter.addSuperPower('code solving')
fireSpitter.addSuperPower('shiny getting')
